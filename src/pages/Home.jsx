...
const featuredProjects = [
  ...
  },
  {
    title: 'Tour My India',
    category: 'Travel',
    description: 'Golden Triangle tour package website with rich destination pages, itinerary layouts, and SEO-optimized landing pages for strong organic visibility.',
          ...
          <div className="hero__grid">
            ...
            <div className="hero__visual">
              <div className="hero__avatar">
                <img src="/src/assets/images/profile-pic.webp" alt="Karaj Singh Profile picture" />
              </div>
